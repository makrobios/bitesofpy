...
async def break_time(delay: Time, loop: int) -> None:
    """Break time
...
async def lunch_time(delay: Time) -> None:
    """Lunch time
...
async def work_time(delay: Time, loop: int) -> None:
    """Work time
...
async def session(
        work_length: Time=TWENTY_FIVE_MIN,
        short_break_length: Time=FIVE_MIN,
        long_break_length: Time=THIRTY_MIN,
) -> None:
    """Session
